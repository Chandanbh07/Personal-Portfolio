    ...
    <section id="experience" className="bg-bg py-16 md:py-24 scroll-mt-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative pl-8 sm:pl-10 md:pl-12">
          {/* Dot */}
          <span className="absolute left-2.5 sm:left-3 md:left-4 top-3 w-3 h-3 rounded-full accent-gradient ring-4 ring-bg" />

          {/* Line */}
          <span className="absolute left-[14px] sm:left-[18px] md:left-[22px] top-6 bottom-0 w-px bg-stroke" />
